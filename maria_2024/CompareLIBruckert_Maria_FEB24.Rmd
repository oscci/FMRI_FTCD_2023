...
myallplot <- ggarrange(allplot[[1]],allplot[[2]],allplot[[3]],allplot[[4]],allplot[[5]],allplot[[6]],allplot[[7]],allplot[[8]],allplot[[9]], allplot[[10]],ncol=2,nrow=5,common.legend=TRUE)
savename<-paste0('LR_6tasks_4mask.png')
...
mytaskx <- mytask
if(mytaskx=='WG' && methX ==1){mytaskx <- 'SG'}
